...
export default function ReviewForm({ venueSlug, venueName, onSuccess }: ReviewFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/public/venues/${venueSlug}/reviews`, {
        method: 'POST',
        headers: {
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    ...
    <div className="pt-2">
      <Button
        ...
        className="w-full bg-[#F8BD36] hover:bg-[#e0a820] text-[#1C3658] font-bold rounded-full border-2 border-[#000000] shadow-[3px_3px_0_#000000] hover:shadow-[5px_5px_0_#000000] transition-all disabled:opacity-50 disabled:cursor-not-allowed py-6 md:py-2"
      >
